...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0007_rename_competiçoes_tp_competiçao_tipo_da_competição'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='titulodoclube', to='core.time')),
            ],
        ),
    ]
