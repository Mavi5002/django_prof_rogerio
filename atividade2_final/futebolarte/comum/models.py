...
class Jogador(models.Model):
    #Relacionamento
    time = models.ForeignKey(Time,on_delete=models.CASCADE, related_name='jogador',null=False, blank=False)
...
class TitulodasCompetições(models.Model):
    #Relacionamento
    time = models.ForeignKey(Time,on_delete=models.CASCADE,related_name='titulodoclube',null=False, blank=False)
